...
* Description:    -                                                    *
************************************************************************
REPORT zdemo_alv01. "Populating internal table and displaying ALV
...
*----------------------------------------------------------------------*
DATA flight_schedules TYPE STANDARD TABLE OF spfli.
...
*&---------------------------------------------------------------------*
  ...
  SELECT * FROM spfli INTO TABLE flight_schedules UP TO 100 ROWS.
